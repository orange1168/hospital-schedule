        ...
        <View className="p-4">
          ...
          <View className="bg-white rounded-lg p-4 mb-6 shadow-sm">
            ...
            <View className="flex flex-row mb-1">
              {/* 固定列：医生 */}
              <View style={{ width: '96px', flexShrink: 0, height: '50px', backgroundColor: '#f5f3ff', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <ScrollView scrollX className="flex-1">
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                  {scheduleData.dates.map((date, index) => (
                    <View key={date} style={{ width: '96px', height: '50px', backgroundColor: '#f5f3ff', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {FIXED_DOCTORS.map((doctor) => {
              const schedule = scheduleData.doctorSchedule[doctor]
              return (
                <View key={doctor} className="flex flex-row mb-1">
                  {/* 固定列：医生姓名 */}
                  <View style={{ width: '96px', flexShrink: 0, height: '50px', backgroundColor: '#f9fafb', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row' }}>
                      {scheduleData.dates.map((date) => {
                        ...
                        return (
                          <View
                            key={date}
                            style={{ width: '96px', height: '50px', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: hasNightShift ? '#ffffff' : '#ffffff' }}
          ...
          <View className="bg-white rounded-lg p-4 mb-6 shadow-sm">
            ...
            <View className="flex flex-row mb-1">
              {/* 固定列：科室 */}
              <View style={{ width: '96px', flexShrink: 0, height: '50px', backgroundColor: '#eff6ff', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <ScrollView scrollX className="flex-1">
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                  {scheduleData.dates.map((date, index) => (
                    <View key={date} style={{ width: '96px', height: '50px', backgroundColor: '#eff6ff', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Text className="block text-xs font-bold text-center">{scheduleData.datesWithWeek[index].split(' ')[0]}</Text>
                      <Text className="block text-xs text-center text-gray-500">{scheduleData.datesWithWeek[index].split(' ')[1]}</Text>
                    </View>
                  ))}
            ...
            {scheduleData.departments.map((department) => (
              <View key={department} className="flex flex-row mb-1">
                {/* 固定列：科室名称 */}
                <View style={{ width: '96px', flexShrink: 0, height: '50px', backgroundColor: '#f9fafb', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <ScrollView scrollX className="flex-1">
                  <View style={{ display: 'flex', flexDirection: 'row' }}>
                    {scheduleData.dates.map((date) => {
                      ...
                      return (
                        <View key={date} style={{ width: '96px', height: '50px', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#ffffff' }}>
          ...
          <View className="bg-white rounded-lg p-4 shadow-sm">
            ...
            <View className="flex flex-row mb-1">
              {/* 固定列：医生 */}
              <View style={{ width: '96px', flexShrink: 0, height: '40px', backgroundColor: '#f0fdf4', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Text className="block text-sm font-bold text-center">医生</Text>
              </View>
              {/* 可滚动列：统计项 */}
              <ScrollView scrollX className="flex-1">
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                  <View style={{ width: '80px', height: '40px', backgroundColor: '#f0fdf4', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {Object.values(scheduleData.doctorSchedule).map((info) => (
              <View key={info.name} className="flex flex-row mb-1">
                {/* 固定列：医生姓名 */}
                <View style={{ width: '96px', flexShrink: 0, height: '40px', backgroundColor: '#f9fafb', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Text className="block text-sm font-medium text-center">{info.name}</Text>
                </View>
                {/* 可滚动列：统计数据 */}
                <ScrollView scrollX className="flex-1">
                  <View style={{ display: 'flex', flexDirection: 'row' }}>
                    <View style={{ width: '80px', height: '40px', padding: '8px', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#ffffff' }}>
