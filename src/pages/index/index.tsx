...
const DOCTOR_DEPARTMENTS = [
  '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '9诊室', '10诊室',
  '妇儿2', '妇儿3', '妇儿4', 'VIP1', 'VIP2', '男1', '男2', '男3', '女1', '女2', '女3',
  '产假', '筛查', '介入'
]
...
const IndexPage = () => {
  ...
  const [selectedDepartments, setSelectedDepartments] = useState<{
    ...
    Monday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '10诊室', '妇儿2', '妇儿3', '妇儿4', 'VIP2', '男2', '女2', '女3'],
    Tuesday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '10诊室', '妇儿2', '妇儿3', '妇儿4', 'VIP2', '男2', '女2', '女3'],
    Wednesday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '10诊室', '妇儿2', '妇儿3', '妇儿4', 'VIP2', '男2', '女2', '女3'],
    Thursday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '10诊室', '妇儿2', '妇儿3', '妇儿4', 'VIP2', '男2', '女2', '女3'],
    Friday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '特需诊室', '10诊室', '妇儿2', '妇儿3', '妇儿4', 'VIP2', '男2', '女2', '女3'],
    Saturday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '妇儿4'],
    Sunday: ['1诊室', '3诊室', '4诊室', '5诊室（床旁超声+术中）', '妇儿4']
  })
